      ...
      >
        ...
        <div className="relative z-10 max-w-3xl mx-auto">
          <motion.span
            ...
            className="inline-block bg-gold text-gray-900 px-4 py-1 rounded-full text-sm font-bold mb-5 tracking-wide"
          >
            {badge}
          </motion.span>
          <motion.h1
      ...
      >
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="bg-white/10 p-8 rounded-[2rem] border border-white/20">
            ...
            {price ? (
              <>
                <div className="text-4xl font-bold text-gold mb-2">{price.split(" / ")[0]}</div>
                {price.includes(" / ") && (
            ...
            <a
              ...
              className="block w-full bg-gold text-gray-900 text-center py-4 rounded-2xl font-bold text-lg hover:bg-gold-light transition-all"
            >
              احجز مقعدك الآن
            </a>
          </div>
